...
prob = json.load(open("./data/probabilities.json"))
  ...
  <script>
    ...
    function renderTitleRaceTable() {{
      ...
      const fmtCell = (val) => {{
        ...
        if (val > 0) return '<span class="stage-pill-partial">' + Math.round(val * 100) + '%</span>';
...
print("✓ Python build of index.html completed.")
